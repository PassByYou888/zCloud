...
type
  ...
  TDTC40_Log_AdminToolForm = class(TForm, IDTC40_PhysicsTunnel_Event)
    logMemo: TMemo;
  ...
  private
    ...
    procedure Do_GetLog(Sender: TDTC40_Log_DB_Client; arry: U_StringArray);
  ...
  public
    ...
    CurrentClient: TDTC40_Log_DB_Client;
  ...
  public
    ...
    constructor Create();
    destructor Destroy; override;
    procedure Do_QueryLog(Sender: TDTC40_Log_DB_Client; LogDB: SystemString; arry: TArrayLogData);
  end;
...
procedure TTemp_Search.Do_QueryLog(Sender: TDTC40_Log_DB_Client; LogDB: SystemString; arry: TArrayLogData);
begin
  L.AddArry(arry);
...
procedure TDTC40_Log_AdminToolForm.Do_QueryResult(Sender: TDTC40_PhysicsTunnel; L: TDTC40_InfoList);
var
...
procedure TDTC40_Log_AdminToolForm.Do_GetLog(Sender: TDTC40_Log_DB_Client; arry: U_StringArray);
var
  itm: TLog_Item;
  i: Integer;
  n: SystemString;
...
procedure TDTC40_Log_AdminToolForm.DTC40_PhysicsTunnel_Connected(Sender: TDTC40_PhysicsTunnel);
begin

end;

procedure TDTC40_Log_AdminToolForm.DTC40_PhysicsTunnel_Disconnect(Sender: TDTC40_PhysicsTunnel);
begin
...
procedure TDTC40_Log_AdminToolForm.DTC40_PhysicsTunnel_Build_Network(Sender: TDTC40_PhysicsTunnel; Custom_Client_: TDTC40_Custom_Client);
begin

end;

procedure TDTC40_Log_AdminToolForm.DTC40_PhysicsTunnel_Client_Connected(Sender: TDTC40_PhysicsTunnel; Custom_Client_: TDTC40_Custom_Client);
var
  info: TDTC40_Info;
begin
  if serviceComboBox.ItemIndex < 0 then
      exit;
  info := TDTC40_Info(serviceComboBox.Items.Objects[serviceComboBox.ItemIndex]);
  if info.Same(Custom_Client_.ClientInfo) and (Custom_Client_ is TDTC40_Log_DB_Client) then
    begin
      CurrentClient := TDTC40_Log_DB_Client(Custom_Client_);
...
begin
  ...
  for i := 0 to DTC40_Registed.Count - 1 do
    begin
      p := DTC40_Registed[i];
      if p^.ClientClass.InheritsFrom(TDTC40_Log_DB_Client) then
        begin
          if depend_.L > 0 then
              depend_.Append('|');
