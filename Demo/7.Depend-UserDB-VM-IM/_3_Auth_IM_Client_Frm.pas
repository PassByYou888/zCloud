...
{$ENDIF FPC}
    ...
    TON_Usr_NewLoginName = class(TOnResultBridge)
    public
      Client: TMyVA_Client;
...
{$ENDIF FPC}
    ...
    TON_Usr_GetAlias = class(TOnResultBridge)
    public
      Client: TMyVA_Client;
...
{$ENDIF FPC}
    ...
    TON_Usr_GetMyFriend = class(TOnResultBridge)
    public
      Client: TMyVA_Client;
  ...
  T_3_Auth_IM_Client_Form = class(TForm, IDTC40_PhysicsTunnel_Event)
    NetTimer: TTimer;
    Memo: TMemo;
...
procedure T_3_Auth_IM_Client_Form.DTC40_PhysicsTunnel_Connected(sender: TDTC40_PhysicsTunnel);
begin

end;

procedure T_3_Auth_IM_Client_Form.DTC40_PhysicsTunnel_Disconnect(sender: TDTC40_PhysicsTunnel);
begin
...
procedure T_3_Auth_IM_Client_Form.DTC40_PhysicsTunnel_Build_Network(sender: TDTC40_PhysicsTunnel; Custom_Client_: TDTC40_Custom_Client);
begin

end;

procedure T_3_Auth_IM_Client_Form.DTC40_PhysicsTunnel_Client_Connected(sender: TDTC40_PhysicsTunnel; Custom_Client_: TDTC40_Custom_Client);
var
  cli: TMyVA_Client;
begin
